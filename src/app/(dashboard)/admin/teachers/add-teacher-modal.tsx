...
import { Loader2, Plus, UploadCloud, FileText, User, Briefcase, FileBadge, Banknote, Check, ChevronsUpDown, X, KeySquare } from "lucide-react";
                            ...
                            <TabsContent value="personal" className="space-y-6">
                                ...
                                <div className="space-y-2 p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl">
                                    <Label className="font-bold text-amber-700 dark:text-amber-500 flex items-center justify-between mb-2">
                                        ...
                                        <span className="text-[10px] font-bold opacity-80 uppercase tracking-widest">(Leave blank for default)</span>
                                    </Label>
                                    <Input 
                                        type="text" 
                                        placeholder="e.g. securePass123" 
                                        className={`bg-background shadow-sm border-amber-500/30 ${errors.password ? 'border-red-500' : ''}`} 
                                        {...register("password")} 
                                    />
