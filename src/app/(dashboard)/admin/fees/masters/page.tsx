...
import { PlusCircle, Settings, Layers, Loader2, Table2, Pencil, Trash2, X } from "lucide-react";
                                        ...
                                        <Table>
                                            <TableHeader className="bg-muted/30">
                                                <TableRow>
                                                    ...
                                                    <TableHead className="h-12 px-6 font-bold text-xs uppercase text-muted-foreground text-right">Actions</TableHead>
                                                </TableRow>
                                            </TableHeader>
                                            <TableBody>
                                                {loadingHeads ? (
                                                    <TableRow><TableCell colSpan={3} className="h-24 text-center"><Loader2 className="h-6 w-6 animate-spin mx-auto text-primary/50" /></TableCell></TableRow>
                                                ) : feeHeads.length > 0 ? (
                                                    feeHeads.map((head) => (
                                                    ...
                                                    <TableRow><TableCell colSpan={3} className="h-24 text-center text-muted-foreground font-medium">No fee heads created yet.</TableCell></TableRow>
                                                )}
                                            </TableBody>
                                        </Table>
                                    </div>
                                        ...
                                        <Table>
                                            ...
                                            <TableBody>
                                                {loadingStructs ? (
                                                    ...
                                                    <TableRow><TableCell colSpan={4} className="h-24 text-center text-muted-foreground font-medium">No fee structures defined yet.</TableCell></TableRow>
                                                )}
                                            </TableBody>
                                        </Table>
                                    </div>
