...
import { Mail, Send, Banknote, History, BarChart3 } from "lucide-react";
...
export default function EmailLayout({ children }: { children: React.ReactNode }) {
    ...
    const navItems = [
        { name: "Overview Analytics", href: "/admin/email", icon: BarChart3 },
        { name: "Compose Campaign", href: "/admin/email/compose", icon: Send },
        { name: "Top-up Credits", href: "/admin/email/recharge", icon: Banknote },
        { name: "Usage Ledger", href: "/admin/email/history", icon: History },
    ];
        ...
        <div className="flex flex-col gap-6 max-w-[1400px] mx-auto w-full pb-10 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col gap-1 pb-4 border-b border-border/40">
                ...
                <p className="text-sm font-medium text-muted-foreground ml-8">
                    Manage your school&apos;s email campaigns, track delivery rates, and securely top-up credits.
                </p>
            </div>
