...
export default function EmailPackagesAdminPage() {
    ...
    const { data: packages = [], isLoading, isError } = useQuery<EmailPackage[]>({
            ...
            <div className="flex-1 space-y-4 p-8 pt-6">
                <div className="flex items-center justify-center h-[400px]">
                    <div className="flex flex-col items-center gap-4 text-center">
                        ...
                        <Button variant="outline" onClick={() => queryClient.invalidateQueries({ queryKey: ["email-packages"] })}>
                            Try Again
                        </Button>
                    </div>
                </div>
                ...
                <div className="flex-1 space-y-4 p-8 pt-6">
                    <div className="flex items-center justify-center h-[400px]">
                        <div className="text-center space-y-2">
                            ...
                            <p className="text-sm text-muted-foreground">You don&apos;t have permission to manage Email bundles.</p>
                        </div>
                    </div>
                </div>
            }
            ...
            <div className="flex-1 space-y-6 p-8 pt-6">
                <div className="flex items-center justify-between">
                    <div className="space-y-1">
                        <h2 className="text-3xl font-bold tracking-tight">Email Bundles</h2>
                        <p className="text-sm text-muted-foreground">
                            Manage email credit packages available for schools.
                        </p>
                    </div>
