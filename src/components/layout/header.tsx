...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-40 w-full flex-shrink-0 bg-[var(--navbar)] border-b border-sidebar-border/50 transition-all h-[72px] sm:h-[80px] flex items-center shadow-sm">
